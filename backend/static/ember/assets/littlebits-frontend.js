...
define('littlebits-frontend/models/event', ['exports', 'ember-data'], function (exports, _emberData) {
  ...
  exports.default = _emberData.default.Model.extend({
    ...
    img: _emberData.default.attr('string', { defaultValue: 'img/event-icon.jpg' }),
    link: _emberData.default.attr('string', { defaultValue: 'index' })
  });
});
